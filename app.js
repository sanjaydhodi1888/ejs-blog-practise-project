...
app.get("/post/:name", (req, resp) => {
  let requestedData = _.lowerCase(req.params.name);
  let searchMatchingPost = [];
  postsArray.forEach((post) => {
    if (requestedData === _.lowerCase(post.title)) {
      let obj = {
        title: post.title,
        content: post.postbody,
      };
      searchMatchingPost.push(obj);
    }
  });
  resp.render("post", { searchMatchingPost: searchMatchingPost });
});
